...
struct StoryBrain {
    ...
    func getFirstChoice() -> String {
        return stories[storyNum].firstChoice
    }
    
    func getSecondChoice() -> String {
        return stories[storyNum].secondChoice
    }
    
    mutating func getNextStory(_ currChoice: String) {
        if (currChoice == stories[storyNum].firstChoice) {
            storyNum = stories[storyNum].firstChoiceDest
        }
        else {
            storyNum = stories[storyNum].secondChoiceDest
        }
    }
